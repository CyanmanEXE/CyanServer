...
chip.card_create_action = function(actor, props, target_tile_in)
        ...
        self:add_anim_action(3, function()
            ...
            action.on_landing = function()
                if target_tile:is_walkable() then
                    ...
                    hit_explosion(user, above_tile, hit_props, explosion_texture, explosion_animation_path, explosion_sfx)
