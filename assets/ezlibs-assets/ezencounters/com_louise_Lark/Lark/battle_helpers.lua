...
function battle_helpers.get_direction_towards_tile(tile1, tile2)
    local check_dirs = { Direction.Left, Direction.Right, Direction.Up, Direction.Down }
    for index, dir in ipairs(check_dirs) do
        if (tile1:get_tile(dir, 1) == tile2) then
            return dir
        end
    end
